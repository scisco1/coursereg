...
<div class="card-block">
                                                    <form method="post" enctype="multipart/form-data">
                                                      <div class="form-group row">
                                                          ...
                                                          <div class="col-sm-10">
                                                              <select name="code" class="form-control coded">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control uni" name="unit" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <button type="submit" name="add_course" class="btn btn-success Adds">Add Course</button>
                                                    </form>
                                                    <?php
                                                    			 if(isset($_POST["add_course"])){
                                                                    ...
                                                                    //echo $fruit_name;
                                                                    $select_Query = "SELECT count(*) as num FROM course where title = '$title' and code = '$code' ";
                                                                    $select_connect = mysqli_query($connect,$select_Query);
                                                                        ...
                                                                        if (mysqli_num_rows($select_connect) > 0) {
                                                                          ...
                                                                          $query  = "INSERT INTO `course`(`id`, `studentid`, `title`, `code`, `unit`, `level`,
                                                                             `semester`, `date`, `status`)
                                                                          VALUES (null,'$ids','$title','$code','$unit','$level','$semester',now(),'0')";
