  ...
  <div class="container">
        ...
        <form method="post">
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="inputEmail" class="form-control" name="matric" placeholder="Matric Number" required="required" autofocus="autofocus">
    ...
    if (isset($_POST['login'])) {
      ...
      if (!empty($matric) && !empty($password) ) {
        // code..
        //echo $matric;
        $select_Query_poll = " SELECT id,password,fullname from student where  matric ='$matric' ";
        ...
        $select_connect_poll = mysqli_query($connnect,$select_Query_poll);
         ...
         if(mysqli_num_rows($select_connect_poll) > 0 ){
           ...
           if ($data_poll['password'] == $password) {
             ...
             $_SESSION['fullname'] = $data_poll['fullname'] ;
             $_SESSION['idf'] = $data_poll['id'] ;
